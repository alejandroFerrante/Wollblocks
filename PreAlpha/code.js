...
Code.init = function() {
  ...
  var toolboxText = document.getElementById('toolbox').outerHTML; //GET TOOLBOX AS TEXT
  toolboxText = toolboxText.replace(/(^|[^%]){(\w+)}/g,
      function(m, p1, p2) {return p1 + MSG[p2];});
  var toolboxXml = Blockly.Xml.textToDom(toolboxText); //CONVERT XML TEXT TO TOOLBOX

  //CONSTRUCT WORKSPACE USING TOOLBOX
